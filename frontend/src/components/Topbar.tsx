					...
					<TooltipProvider>
						<Tooltip>
							<TooltipTrigger asChild>
								<Link to="/premium" className={cn(buttonVariants({ variant: "outline", size: "sm" }), "bg-gradient-to-r from-amber-500 to-yellow-300 text-black border-none hover:from-amber-600 hover:to-yellow-400")}>
